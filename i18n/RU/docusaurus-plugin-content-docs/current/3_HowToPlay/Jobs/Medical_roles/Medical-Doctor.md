# Врач
**Тип роли:** <font color="#d673b2">Медицинская</font>. **Доступ:** <font color="#d673b2">Медбай</font>, <font color="#d673b2">Клонирование</font>, <font color="#d673b2">Морг</font>, <font color="#d673b2">Хирургия</font> , **Сложность:** <font color="Yellow">Средняя</font>.

## Обзор

Роль врача, пожалуй, самая важная для поддержания спокойствия на станции, за исключением [Security](\3_HowToPlay\Jobs\Security_roles\Security-Officer.md) и [Управление](\3_HowToPlay\Jobs\Command_roles\Captain.md). Их работа заключается в лечении раненых, возвращении к жизни умерших членов экипажа и снабжении камбуза трупами, когда заканчиваются другие источники пищи.
