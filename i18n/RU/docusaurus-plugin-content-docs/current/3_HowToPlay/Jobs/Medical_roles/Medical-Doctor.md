...
Роль врача, пожалуй, самая важная для поддержания спокойствия на станции, за исключением [Security](Security.md) и [Control](\3_HowToPlay\Jobs\Command_roles\Captain.md). Их работа заключается в лечении раненых, возвращении к жизни умерших членов экипажа и снабжении камбуза трупами, когда заканчиваются другие источники пищи.
