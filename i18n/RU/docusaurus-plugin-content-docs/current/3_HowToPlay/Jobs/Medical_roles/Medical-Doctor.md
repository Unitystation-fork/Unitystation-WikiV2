# Врач
**Тип роли:** <font color="#d673b2">Медицинская</font>. **Доступ:** <font color="#d673b2">Медбей</font>, <font color="#d673b2">Клонирование</font>, <font color="#d673b2">Морг</font>, <font color="#d673b2">Хирургия</font> , **Сложность:** <font color="Yellow">Средняя</font>.

## Обзор

Роль врача, пожалуй, самая важная для поддержания спокойствия на станции, за исключением [СБ](\3_HowToPlay\Jobs\Security_roles\Security-Officer.md) и [Командования](\3_HowToPlay\Jobs\Command_roles\Captain.md). Их работа заключается в лечении раненых, возвращении к жизни умерших членов экипажа и снабжении камбуза трупами, когда заканчиваются другие источники пищи.
...
- **Отравление Токсинами** - самый распространенный тип. Токсинный урон достигается при употреблении токсинов и яда, дыхании плазменным газом, а также при использовании некоторых редких видов оружия, например энергетического арбалета. Он также накапливается от радиационного отравления. Повреждение токсинами медленно перерабатывается печенью, поэтому проверьте, есть ли она у вашего пациента. Его также можно лечить с помощью таблеток древесного угля, поэтому попросите аптекаря изготовить их, если это необходимо.
...
Обратите внимание, что критический недостаток процесса клонирования заключается в том, что для него в первую очередь необходим труп, причем такой, который не был бы слишком пережеван. Если тело потеряно в космосе, если оно лишено мозга, если его изгрызли взрывы, если его зарезал [шеф] (Cook.md), или если оно получилось достаточно сильные повреждения от огня, чтобы превратиться в шелуху, то оно не может быть проанализировано сканером ДНК.
...
1) Окажите помощь тяжелораненым членам экипажа в бункере. Они являются главным приоритетом. Мертвецы, ожидающие клонирования, могут подождать еще немного. Большого риска при выполнении этой операции нет, так как у людей часто есть другие приоритеты, кроме того, как убить вас, когда они еще не мертвы.
...
Если вы столкнулись с хирургической процедурой и не знаете, какие инструменты использовать, обычно вы можете форсировать ее, перепробовав все инструменты, то пока не будет сделан следующий шаг.
