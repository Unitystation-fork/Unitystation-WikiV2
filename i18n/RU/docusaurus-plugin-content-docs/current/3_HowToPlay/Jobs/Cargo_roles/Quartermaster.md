...
*Распределить все [строительные](\3_HowToPlay\Guides\Engineering_guides\Construction.md) материалы (стекло и металл) по токарным станкам или [Инженерам](Engineering.md)
