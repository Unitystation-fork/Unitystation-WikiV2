...
| Code |                                                              | Crime                           | Description                                                  | Notes                                                        |
| ---- | ------------------------------------------------------------ | ------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 201 | x | **Assaut** | Utiliser la force physique contre quelqu'un sans l'intention apparente de le tuer. | Selon la quantité et le type de force utilisée, les cas graves devraient être élevés au rang de tentative d'homicide involontaire ou même de meurtre. Les agressions avec des armes mortelles sont un crime plus élevé. |
| 202  | x | **Pick-Pocketing**              | Le vol d'objets sur la personne d'une autre personne.                        | N'oubliez pas de prendre les objets volés à la personne et de prendre des dispositions pour les lui rendre. Le vol d'une pièce d'identité est la forme la plus courante et la plus grave de vol à la tire. |
| 203 | x | **Distribution de stupéfiants**  | Distribuer des stupéfiants et d'autres substances contrôlées.     | Forcer ou inciter quelqu'un à consommer des substances telles que les drogues spatiales constitue une agression. |
| 204 | [arme](Possession_d'arme.png)  | Possession d'une arme** | Être en possession d'un objet dangereux qui ne fait pas partie de son rôle professionnel. | Les objets capables d'infliger des dégâts importants, comme les scies, les haches et les hachettes, entrent dans cette catégorie. N'oubliez pas que s'il s'agit d'un objet qui fait partie de leur travail, ils sont autorisés à le porter. |
| 205 | [animaux](ian.png) | La cruauté envers les animaux, ou la maltraitance des animaux, est le fait pour un être humain de soumettre un animal, qu'il soit sauvage, domestique, apprivoisé ou tenu en captivité, à un acte destiné à lui nuire, sous une forme active ou passive, généralement par pur plaisir. | Exemption pour stricte nécessité professionnelle :  - Le généticien sur les singes s'il est dans son laboratoire. - Le cuisinier dans l'arrière-cuisine (non public) -- ps : Ian n'est pas un animal, c'est un membre de l'équipage. |
| 206 | x | **rebellion**                     | Participer à un rassemblement non autorisé et perturbateur de membres d'équipage qui refusent de se disperser. | Il est nécessaire d'ordonner à la foule de se disperser, le refus de se disperser est le crime, pas le rassemblement. Tout crime commis pendant l'émeute est considéré comme une infraction distincte. |
| 207 | x | **Créer un danger sur le lieu de travail** | Mettre en danger l'équipage ou la station par des actions négligentes ou irresponsables, mais pas délibérément malveillantes. | De bons exemples de ce crime consistent à provoquer accidentellement une fuite de plasma, un risque de glissade, à électrifier accidentellement des portes, à briser des fenêtres pour accéder à l'espace, ou à faire en sorte que le personnel de sécurité ne garde pas son équipement en sécurité. |
| 208 | x | Vol à l'arraché** | Prendre des objets dans des zones auxquelles on n'a pas accès ou prendre des objets appartenant à d'autres personnes ou à la station dans son ensemble. | L'important, c'est de garder à leur place les objets qui sont en quantité limitée. Un médecin qui prend tous les outils chirurgicaux et les cache commet un vol, même s'il y avait accès. |
| 210 | x | **Entrée par effraction** | Entrée forcée dans des zones auxquelles le sujet n'a pas accès. Cela compte pour les zones générales, et l'entrée par effraction dans des zones restreintes est un crime plus grave. | L'équipage peut être accusé d'effraction même s'il n'a pas pénétré dans la zone en question. |
| 211 | x | **Insubordination**             | Désobéir à un ordre direct et légitime d'un supérieur. | Ordre donné par un chef d'état-major à l'un de ses subordonnés directs. La personne est généralement rétrogradée au lieu d'être incarcérée. La sécurité est censée aider le chef à exécuter la rétrogradation.
...
| Code |                                                              | Crime                                 | Description                                                  | Notes                                                        |
| ---- | ------------------------------------------------------------ | ------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 301 | x | **Assaut avec une arme mortelle** | Utiliser la force physique, au moyen d'une arme mortelle, contre quelqu'un sans l'intention apparente de le tuer. | Toute une variété d'outils, de produits chimiques ou même de matériaux de construction peuvent infliger des blessures graves en peu de temps. Si la victime a été particulièrement brutalisée, envisagez de l'inculper pour tentative de meurtre. |
| 302 | x | **Agression d'un agent** | Utiliser la force physique contre un chef de service ou un membre de la sécurité sans l'intention apparente de le tuer. | Les criminels qui tentent de désarmer ou d'attraper les agents en s'enfuyant sont coupables de cette infraction, même s'ils ont les mains nues. Les agents doivent s'abstenir d'utiliser des moyens létaux pour maîtriser le criminel si possible. |
| 303 | x | **Meurtre involontaire***.                     | Les agents doivent s'abstenir d'utiliser des moyens mortels pour maîtriser le criminel, si possible. | L'intention est importante. Les décès accidentels causés par des actions négligentes, telles que la création de dangers sur le lieu de travail (par exemple, des fuites de gaz), l'altération de l'équipement, la force excessive et l'enfermement dans des conditions dangereuses sont des exemples d'homicide involontaire. |
